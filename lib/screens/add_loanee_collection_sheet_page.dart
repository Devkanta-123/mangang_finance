            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const Divider(height: 12),
                  _buildReceiptRow('Loan Sanction Date', _selectedLoaneeAccount?.formattedSanctionDate ?? 'N/A'),
                  const Divider(height: 12),
                  _buildReceiptRow('Loan Maturity Date (5m)', _selectedLoaneeAccount?.formattedMaturityDate ?? 'N/A'),
                ],
              ),
            ),
          ],
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        Text('Sanction Date: ${_selectedLoaneeAccount!.formattedSanctionDate}',
                                            style: TextStyle(fontSize: 10.5, fontWeight: FontWeight.w600, color: Colors.grey.shade800)),
                                        Text('Maturity (5m): ${_selectedLoaneeAccount!.formattedMaturityDate}',
